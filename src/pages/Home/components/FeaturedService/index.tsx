      ...
      <div className="mt-8 ">
        <div className="grid xs:grid-cols-1 sm:grid-cols-2  gap-4 ">
          {services.map((service, index) => (
           <div
           key={index}
           className="glassy-bg flex flex-col justify-between gap-10 border-2 transform transition-all duration-300 rounded-xl cursor-pointer px-6 py-5 relative overflow-hidden hover:bg-gradient-to-tl from-yellow-opacity0.2 to-transparent  "
         >
