...
const Almuqtadir = () => {
  return (
    <>
     <section   className="w-full h-full xl:h-[400px] bg-cover bg-center flex flex-col justify-start items-center gap-9 xs:pt-[7.5rem] md:pt-[15%] lg:pt-[13%] 2xl:pt-[8%] xs:px-5 3xl:container 3xl:mx-auto"
      ...
      <div className="flex justify-start mt-[77px] gap-[33px]">
        ...
        <div className="grid grid-rows-2 gap-[16px] z-30">
          <div className="glassy-bg flex flex-col justify-center items-center border-2  rounded-[20px] p-[28px] w-[345px]">
            <h6 className="font-black  text-[104px] capitalize ">$31M</h6>
            <p className="text-[16px] text-[#979797] capitalize text-center">
              2020Uber revenue came to $11.3billion - a 43% increase on 2018,
              while gross
            </p>
          </div>
          <div className="glassy-bg  flex flex-col justify-center items-center border-2  rounded-[20px] p-[28px] w-[345px]">
            <h6 className="font-black  text-[104px] capitalize ">$24M</h6>
            <p className="text-[16px] text-[#979797] capitalize text-center">
              2022 Uber revenue came to $11.3billion - a 43% increase on 2018,
              while gross
            </p>
          </div>
        </div>
